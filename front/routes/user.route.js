...
router.get("/welcome", (req, res, next) => controller.getWelcome(req, res, next));

router.get("/signin", (req, res, next) => controller.getSignin(req, res, next));

router.get("/profile", (req, res, next) => controller.getProfileModify(req, res, next));

router.post("/profile", (req, res, next) => controller.postProfileModify(req, res, next));

router.get("/kakao/login", (req, res, next) => controller.getKakaoLogin(req, res, next));
